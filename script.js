...
function startMusic() {
  bgMusic.play().catch(err => console.log('Gagal play musik:', err));
  toggleMusic.classList.remove('d-none');
}
...
new TypeIt("#teks1", {
  strings: ["Dibaca yah Princes", " ", "Saya Mahendra Dinata pada hari ini Rabu, 1 Juli 2026 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke - 19</b>", " ", "Kepada Distialya azmina, semoga kamu panjang umur, dan bahagia selalu. ❤️🌷. Sekian surat pernyataan dari saya", , " ", "I Love You", " ", "- Mahendra Dinata, Pacar Ganteng Mu :)"],
  startDelay: 4000,
  speed: 75,
